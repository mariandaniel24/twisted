...
exports.regionToRegionGroup = exports.RegionGroups = exports.TournamentRegions = exports.Regions = void 0;
var Regions;
(function (Regions) {
    Regions["BRAZIL"] = "BR1";
...
var TournamentRegions;
(function (TournamentRegions) {
    TournamentRegions["BR"] = "BR";
    TournamentRegions["EUNE"] = "EUNE";
    TournamentRegions["EUW"] = "EUW";
    TournamentRegions["JP"] = "JP";
    TournamentRegions["LAN"] = "LAN";
    TournamentRegions["LAS"] = "LAS";
    TournamentRegions["NA"] = "NA";
    TournamentRegions["OCE"] = "OCE";
    TournamentRegions["PBE"] = "PBE";
    TournamentRegions["RU"] = "RU";
    TournamentRegions["TR"] = "TR";
    TournamentRegions["KR"] = "KR";
})(TournamentRegions = exports.TournamentRegions || (exports.TournamentRegions = {}));
/**
 * As per RIOT Api:
