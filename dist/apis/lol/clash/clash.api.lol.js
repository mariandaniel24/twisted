...
class ClashApi extends base_api_lol_1.BaseApiLol {
    ...
    playersList(encryptedSummonerId, region) {
        return this.request(region, endpoints_1.endpointsClashV1.GetPlayers, { params: { encryptedSummonerId } });
    }
    /**
     * Get team by id
     * @param region
    ...
    getTeamById(teamId, region) {
        return this.request(region, endpoints_1.endpointsClashV1.GetTeam, { params: { teamId } });
    }
    /**
    ...
    getTeamTournament(teamId, region) {
        return this.request(region, endpoints_1.endpointsClashV1.GetTournamentByTeamId, { params: { teamId } });
    }
    /**
     * Get tournament by id
     */
    getTournamentById(tournamentId, region) {
        return this.request(region, endpoints_1.endpointsClashV1.GetTournamentById, { params: { tournamentId } });
    }
}
