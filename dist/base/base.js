...
class BaseApi {
    ...
    retryRateLimit(region, endpoint, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < this.rateLimitRetryAttempts; i++) {
                try {
                    const response = yield this.request(region, endpoint, opts);
                    return response;
                }
                catch (error) {
                    ...
                    const waitSeconds = this.isServiceUnavailableError(forceError) ? base_const_1.BaseConstants.SERVICE_UNAVAILABLE : base_const_1.BaseConstants.RATE_LIMIT;
    ...
    request(region, endpoint, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const options = {
                ...
                data: opts === null || opts === void 0 ? void 0 : opts.body,
                params: queryParams
            };
            ...
            try {
                ...
                return yield this.retryRateLimit(region, endpoint, opts);
            }
            finally {
                if (this.debug.logTime) {
